...
results.append(
    {'line_count': 3, 'missing': [ValidationIssue(line=LinkLineNumber(number=0, line='[test](test.txt)', matches=[MarkdownLinkRuleResult(full='[test](test.txt)', text='test', url='test.txt')]), issue=Path('test.txt')), ValidationIssue(line=LinkLineNumber(number=2, line='[test](test.txt) and [test2](https://www.google.com)', matches=[MarkdownLinkRuleResult(full='[test](test.txt)', text='test', url='test.txt')]), issue=Path('test.txt'))]}
)
...
results.append(
    {'line_count': 3, 'incorrect': [ValidationIssue(line=LinkLineNumber(number=0, line='[test](test.txt)', matches=[MarkdownLinkRuleResult(full='[test](test.txt)', text='test', url='test.txt')]), issue=Path('test.txt')), ValidationIssue(line=LinkLineNumber(number=1, line='![image](/image.png)', matches=[MarkdownImageLinkRuleResult(full='![image](/image.png)', text='image', url='/image.png')]), issue=Path('/image.png')), ValidationIssue(line=LinkLineNumber(number=2, line='[test](test.txt) and [test2](https://www.google.com)', matches=[MarkdownLinkRuleResult(full='[test](test.txt)', text='test', url='test.txt')]), issue=Path('test.txt'))]}
)
